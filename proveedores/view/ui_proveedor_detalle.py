...
################################################################################
## Form generated from reading UI file 'proveedor_detalleSWOLAE.ui'
##
...
"}")
        ...
        self.formLayout_2.setWidget(8, QFormLayout.LabelRole, self.lbl_email)

        self.le_email = QLineEdit(Form)
        self.le_email.setObjectName(u"le_email")

        self.formLayout_2.setWidget(8, QFormLayout.FieldRole, self.le_email)

        self.lbl_contacto = QLabel(Form)
        self.lbl_contacto.setObjectName(u"lbl_contacto")

        self.formLayout_2.setWidget(9, QFormLayout.LabelRole, self.lbl_contacto)

        self.le_contacto = QLineEdit(Form)
        self.le_contacto.setObjectName(u"le_contacto")

        self.formLayout_2.setWidget(9, QFormLayout.FieldRole, self.le_contacto)

        self.label = QLabel(Form)
        self.label.setObjectName(u"label")

        self.formLayout_2.setWidget(7, QFormLayout.LabelRole, self.label)

        self.le_movil = QLineEdit(Form)
        self.le_movil.setObjectName(u"le_movil")

        self.formLayout_2.setWidget(7, QFormLayout.FieldRole, self.le_movil)
        ...
        self.tv_materias_primas = QTableView(self.groupBox)
        self.tv_materias_primas.setObjectName(u"tv_materias_primas")

        self.verticalLayout.addWidget(self.tv_materias_primas)
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(QCoreApplication.translate("Form", u"Detalle proveedor", None))
        ...
        self.label.setText(QCoreApplication.translate("Form", u"M\u00f3vil", None))
        ...
        self.groupBox.setTitle(QCoreApplication.translate("Form", u"Materias Primas", None))
