...
################################################################################
## Form generated from reading UI file 'ventana_producto_detalle4zxBtME.ui'
##
...
"}")
        ...
        self.de_fecha_cad_fab.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.NoButtons)
    ...
    def retranslateUi(self, Form):
        ...
        self.lbl_linea_det.setText(QCoreApplication.translate("Form", u"Caducidad", None))
