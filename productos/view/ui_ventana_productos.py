...
"")
        ...
        self.lbl_fecha_cad_prod = QLabel(self.tab_nuevo_producto)
        self.lbl_fecha_cad_prod.setObjectName(u"lbl_fecha_cad_prod")

        self.formLayout.setWidget(1, QFormLayout.LabelRole, self.lbl_fecha_cad_prod)

        self.le_caducidad_prod = QLineEdit(self.tab_nuevo_producto)
        self.le_caducidad_prod.setObjectName(u"le_caducidad_prod")

        self.formLayout.setWidget(1, QFormLayout.FieldRole, self.le_caducidad_prod)
