...
################################################################################
## Form generated from reading UI file 'ventana_productos2NORegP.ui'
##
...
"")
        ...
        self.btn_add2_list_prod = QPushButton(self.tab_detalle_producto)
        self.btn_add2_list_prod.setObjectName(u"btn_add2_list_prod")

        self.horizontalLayout_3.addWidget(self.btn_add2_list_prod)

        self.btn_delete_list_prod = QPushButton(self.tab_detalle_producto)
        self.btn_delete_list_prod.setObjectName(u"btn_delete_list_prod")
        self.btn_delete_list_prod.setStyleSheet(u"background-color: rgb(254, 20, 20);")

        self.horizontalLayout_3.addWidget(self.btn_delete_list_prod)
    ...
    def retranslateUi(self, Form):
        ...
        self.btn_add2_list_prod.setText(QCoreApplication.translate("Form", u"A\u00f1adir", None))
        self.btn_delete_list_prod.setText(QCoreApplication.translate("Form", u"Eliminar", None))
        self.le_buscar_prod.setPlaceholderText(QCoreApplication.translate("Form", u"Buscar por nombre", None))
