...
################################################################################
## Form generated from reading UI file 'ventana_producto_detalleWPIKtK.ui'
##
...
"}")
        ...
        self.le_cliente_det = QLineEdit(self.tab_detalle)
        self.le_cliente_det.setObjectName(u"le_cliente_det")

        self.formLayout.setWidget(3, QFormLayout.FieldRole, self.le_cliente_det)
        ...
        self.tv_composicion_prod = QTableView(self.groupBox)
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox.setTitle(QCoreApplication.translate("Form", u"Composici\u00f3n", None))
        ...
        self.groupBox_2.setTitle(QCoreApplication.translate("Form", u"Fabricaciones", None))
