...
CREATE TABLE
	rel_emp (
		...
		mp_id_emp int not null,
		prov_id_emp int not null,
		constraint pk_emp PRIMARY KEY (ent_id_emp, mp_id_emp, prov_id_emp),
...
INSERT INTO rel_ocm(ord_id_ocm,cosmetico_id_ocm,mp_id_ocm) values (1,1, 1),
	(1,1, 2),
	(1,1, 3),
	(1,1, 13),
	(1,1, 7),
