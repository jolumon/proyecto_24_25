...
################################################################################
## Form generated from reading UI file 'ventana_clientes2gVzogY.ui'
##
...
"")
        ...
        self.formLayout.setWidget(6, QFormLayout.LabelRole, self.lbl_email)

        self.le_email = QLineEdit(self.tab_nuevo)
        self.le_email.setObjectName(u"le_email")

        self.formLayout.setWidget(6, QFormLayout.FieldRole, self.le_email)

        self.lbl_contacto = QLabel(self.tab_nuevo)
        self.lbl_contacto.setObjectName(u"lbl_contacto")

        self.formLayout.setWidget(7, QFormLayout.LabelRole, self.lbl_contacto)

        self.le_contacto = QLineEdit(self.tab_nuevo)
        self.le_contacto.setObjectName(u"le_contacto")

        self.formLayout.setWidget(7, QFormLayout.FieldRole, self.le_contacto)
        ...
        self.tv_clientes = QTableView(self.tab_detalle)
        self.tv_clientes.setObjectName(u"tv_clientes")

        self.verticalLayout_2.addWidget(self.tv_clientes)
    ...
    def retranslateUi(self, Form):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_detalle), QCoreApplication.translate("Form", u"Listado Clientes", None))
    # retranslateUi
